...
function calculateStats(type: AV, samples: OT.SubscriberStats[]): QualityStats[] {
...
export default function calculateQualityStats(latestSamples: OT.SubscriberStats[]): HasAudioVideo<QualityStats[]> {
