...
//     callback: (error: OT.OTError | undefined, devices?: Device[]) => void,
//   ): void;
...
//     disconnect(): void;
//     forceDisconnect(connection: Connection, callback: (error?: OT.OTError) => void): void;
//     forceUnpublish(stream: Stream, callback: (error?: OT.OTError) => void): void;
//     getPublisherForStream(stream: Stream): Publisher | undefined;
//     getSubscribersForStream(stream: Stream): [Subscriber];
//     publish(publisher: Publisher, callback: (error?: OT.OTError) => void): void;
...
//     getImgData(): string | null;
//     getStats(callback: (error?: OT.OTError, stats?: SubscriberStats) => void): void;
...
//   export function reportIssue(callback: (error?: OT.OTError, reportId?: string) => void): void;
